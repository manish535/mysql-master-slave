...
# Fix to relay log
docker exec mysql_slave sh -c "export MYSQL_PWD=111; mysql -u root -e 'stop slave \G'"
docker exec mysql_slave sh -c "export MYSQL_PWD=111; mysql -u root -e 'reset slave \G'"
docker exec mysql_slave sh -c "export MYSQL_PWD=111; mysql -u root -e 'start slave \G'"
